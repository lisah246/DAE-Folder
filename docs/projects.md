...
![alt text](ProjectPulseDashboard.PNG) 
<br><br>
![alt text](ProjectPulseProjectDetails.PNG) 
<br><br>
![alt text](ProjectPulseProjects.PNG)
...
<div style="text-align:center; margin-top:3rem; padding:2rem; background:#f8f9fa; border-radius:8px;">
  ...
  <div style="margin-top:2rem;">
    <img src="{{ '/assets/img/dae_logo.jpg' | relative_url }}" alt="DAE Logo" style="height:40px; opacity:0.7;">
  </div>
</div>
